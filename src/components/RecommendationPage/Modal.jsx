...
function Modal({ closeModal, interestvalues }) {
    ...
    return (
        <div className="Modal bg-gray-600 bg-opacity-70 z-30 w-full py-5 fixed flex justify-center">
            <div className="ModalContainer relative md:w-1/2 w-full md:mx-0 mx-5 rounded-md shadow-2xl rounded-lg bg-white flex flex-col">
                <div className="flex flex-col items-center py-1 pl-1">
                    <div className='w-full relative font-semibold bold text-white text-3xl'>
                        <button id="close" onClick={close} className='px-3 pb-1 absolute rounded-lg right-2 top-1 hover:bg-gray-800'>x</button>
                    </div>

                    <div className="bg-[#0F2A36] rounded-lg">
                        <div
