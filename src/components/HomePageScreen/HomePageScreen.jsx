    ...
    <>
        ...
        >
          <nav className="container md:flex items-center flex-row w-full py-[5px] md:pl-0 pl-5 md:px-1">
            ...
            <div className="w-1/4 flex items-center justify-end">
              ...
              <div onClick={() => setDrop(!drop)} ref={dropRef} className="flex w-14 h-14 items-center justify-center mx-2">
      ...
      <Tooltip className="transition delay-40 ease-in duration-400 text-black" title="Create Post" arrow>
        <div id="post" className="z-20 fixed bottom-7 right-80 rounded-full shadow-xl bg-green-600 pr-4 pl-3 py-2">
          <button onClick={post} className="text-2xl font-black text-white font-bold text-center"><i className="fa fa-paper-plane"></i></button>
        </div>
      </Tooltip>
      <div
